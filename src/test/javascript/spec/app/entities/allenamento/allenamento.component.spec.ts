...
import { AllenamentoComponent } from 'app/entities/allenamento/allenamento.component';
...
describe('Component Tests', () => {
  describe('Allenamento Management Component', () => {
    let comp: AllenamentoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AllenamentoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.allenamentos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
