...
import { SpecialistaComponent } from 'app/entities/specialista/specialista.component';
...
describe('Component Tests', () => {
  describe('Specialista Management Component', () => {
    let comp: SpecialistaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SpecialistaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.specialistas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
